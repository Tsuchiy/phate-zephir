...
abstract class Core
{
     ...
     * @param boolean $serverEnv environment
     * @param boolean $baseDirectory base directory
     *
     * @return Core
     */
    abstract public static function getInstance(string $appName=null, bool $isDebug=false, string $serverEnv="local", string $baseDirectory=null);
